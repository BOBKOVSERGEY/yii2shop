            ...
            <div class="product-image-wrapper">
              <div class="single-products">
                <div class="productinfo text-center">
                  ...
                  <a href="<?php echo \yii\helpers\Url::to(['cart/add', 'id' => $hit->id]); ?>" class="btn btn-default add-to-cart" data-id="<?php echo $hit->id; ?>"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                </div>
                <?php if ($hit->new) { ?>
